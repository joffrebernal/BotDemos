...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerDialog() : base(new QnAMakerService(new QnAMakerAttribute(Utils.GetAppSetting("QnASubscriptionKey"), Utils.GetAppSetting("QnAKnowledgebaseId"), "No se encontro lo buscado en el FAQ.", 0.5)))
        {}
    }
}